...
export default function Portal() {
  ...
  return (
    ...
    <div style={s.page}>
      ...
      <div style={s.heroRow}>
        <a href="#" style={{ ...s.heroBtn, background: '#FFD000', color: '#F2F5F8' }}>
          <ClockIcon width={40} height={40} />
          <span>MARCAR ENTRADA / SALIDA</span>
        </a>
        <a href="https://cash.portiahart.com" style={{ ...s.heroBtn, background: '#FC0083', color: '#F2F5F8' }}>
...
const s: Record<string, React.CSSProperties> = {
  ...
  box: { borderRadius: 14, padding: '22px 20px', background: '#4A9B8E' },
  boxLabel: { fontSize: '0.58rem', fontWeight: 500, letterSpacing: '0.24em', marginBottom: 12, color: 'rgba(242,245,248,0.7)' },
