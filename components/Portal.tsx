  ...
  return (
    <div style={s.page}>
      ...
      <main style={s.main}>
        ...
        {/* Hero buttons */}
        <div style={s.heroRow}>
          <a href="https://script.google.com/macros/s/AKfycbwy8xz90Rz81aCeuwoHbHR2-1SM7GeRexwy8LljBquCkNGVW9Op9UKbcEsHg-CvX8F0Xg/exec" style={{ ...s.heroBtn, background: '#FFD000' }}>
