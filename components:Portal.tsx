  ...
  return (
    <div style={s.page}>
      ...
      <div style={{ ...s.box, background: '#4A9B8E' }}>
        ...
        <div style={s.grid2}>
          <AppBtn href="https://cash.portiahart.com" style={s.btnIce}>
            <RulerHorizontalIcon /> CONTABILIDAD
          </AppBtn>
          <AppBtn href="https://prov.portiahart.com" style={s.btnIce}>
            <HeartFilledIcon /> PROVEEDORES
          </AppBtn>
          <AppBtn href="#" style={s.btnIce}>
            <BackpackIcon /> REVISIÓN FISCAL
          </AppBtn>
        </div>
      </div>
      ...
      <div style={{ ...s.box, background: '#1F2D3D' }}>
        ...
        <div style={s.grid2}>
          <AppBtn href="#" style={{ ...s.btnIce, opacity: 0.4, pointerEvents: 'none' }}>
            <CalendarIcon /> RESERVAS
          </AppBtn>
          <AppBtn href="https://events.portiahart.com" style={s.btnIce}>
            <RocketIcon /> PLANES DE EVENTOS
          </AppBtn>
          <AppBtn href="#" style={{ ...s.btnIce, opacity: 0.4, pointerEvents: 'none' }}>
            <CubeIcon /> INVENTARIOS
          </AppBtn>
          <AppBtn href="https://vacantes.portiahart.com/" style={s.btnIce}>
            <FaceIcon /> CANDIDATOS
          </AppBtn>
        </div>
      </div>
      ...
      <div style={{ ...s.box, background: '#FC0083' }}>
        ...
        <div style={s.grid2}>
          <AppBtn href="https://crm.portiahart.com" style={s.btnWhiteMango}>
            <PersonIcon /> CRM
          </AppBtn>
          <AppBtn href="https://quote.portiahart.com" style={s.btnWhiteMango}>
            <MagicWandIcon /> COTIZACIONES
          </AppBtn>
        </div>
      </div>
...
function AppBtn({ href, style, children }: { href: string; style: React.CSSProperties; children: React.ReactNode }) {
  return (
    <a href={href} style={{ ...s.appBtn, ...style }}>
      {children}
    </a>
  )
}
...
const s: Record<string, React.CSSProperties> = {
  page: {
    maxWidth: 580, margin: '0 auto', padding: '40px 20px 60px',
  ...
  heroBtn: {
    ...
    justifyContent: 'center', textAlign: 'center', textDecoration: 'none',
    borderRadius: 14, padding: '28px 16px', gap: 16,
    fontSize: '0.66rem', fontWeight: 500, letterSpacing: '0.14em', lineHeight: 1.4,
  },
  ...
  appBtn: {
    ...
    gap: 8, textDecoration: 'none', borderRadius: 10, padding: '14px 12px',
